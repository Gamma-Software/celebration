...
export default function CelebrationFull() {
  return (
            ...
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  <Cloud aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
                  <span>
                ...
                <li className="flex gap-x-3">
                  <Server aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
                  <span>
